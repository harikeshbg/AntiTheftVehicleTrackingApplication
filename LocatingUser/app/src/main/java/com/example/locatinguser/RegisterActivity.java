...
public class RegisterActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(getApplicationContext(),AunthenticationActivity.class));
            }
        });
                ...
                fauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        if(task.isSuccessful())
                        {
                            ...
                            startActivity(new Intent(getApplicationContext(),AunthenticationActivity.class));//to move to first activity upon successful registeration
                        }
                        else
                        {
