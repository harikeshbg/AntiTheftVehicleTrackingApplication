...
public class DeviceAuthenticationActivity extends AppCompatActivity
{
            ...
            public void onClick(View v)
            {
                ...
                fAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        ...
                        {
                            Toast.makeText(DeviceAuthenticationActivity.this, "Logged in..", Toast.LENGTH_SHORT).show();
                            logBar.setVisibility(View.INVISIBLE);
                                ...
                                Toast.makeText(DeviceAuthenticationActivity.this, "uid:" + uid, Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(DeviceAuthenticationActivity.this, "Log in unsuccessful:" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            logBar.setVisibility(View.INVISIBLE);
                            offButton.setClickable(false);
                        }
                    }
